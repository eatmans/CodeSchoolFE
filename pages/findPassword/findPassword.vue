<template>
	<view class="u-flex u-flex-col">
		...
		<u-form :model="form" ref="uForm" class="c-container">
			...
			<u-form-item prop="securityCode">
				<u-input v-model.trim="form.securityCode" placeholder="验证码" />
				<u-button class="code"  type="success" @click="getCode">发送验证码</u-button>
			...
			<u-form-item prop="inputPassword">
				...
				<u-input v-model.trim="form.inputPassword" :border-bottom="form.borderBottom"
					placeholder="新密码(6-12位数字字母组合密码)" type="password" />
			</u-form-item>

			<u-form-item prop="confirmPassword">
				<u-input v-model.trim="form.confirmPassword" :border-bottom="form.borderBottom" placeholder="再输入一次密码"
					type="password" />
			</u-form-item>
		</u-form>

		<u-button class="c-botton" type="primary" :ripple="true" @click="submit">确认</u-button>
